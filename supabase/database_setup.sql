...
--
-- Name: convert_to_timezone(timestamp with time zone, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.convert_to_timezone(query_time timestamp with time zone, target_timezone text) RETURNS timestamp with time zone
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN query_time AT TIME ZONE target_timezone;
END;
$$;


--
-- Name: update_adjusted_query_time(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_adjusted_query_time() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    NEW.adjusted_query_time := convert_to_timezone(
        NEW.query_time,
        (SELECT time_zone FROM routes WHERE id = NEW.route)
    );
    RETURN NEW;
END;
$$;
...
--
-- Name: update_related_commutes(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_related_commutes() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    -- Only proceed if time_zone has changed
    IF OLD.time_zone IS DISTINCT FROM NEW.time_zone THEN
        UPDATE commutes
        SET adjusted_query_time = convert_to_timezone(query_time, NEW.time_zone)
        WHERE route = NEW.id;
    END IF;
    RETURN NEW;
END;
...
--
-- Name: commutes; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.commutes (
    ...
    to_work boolean NOT NULL,
    day_of_week character varying,
    adjusted_query_time timestamp with time zone
);
...
CREATE SEQUENCE public.commutes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE TABLE public.route_schedule (
    id bigint NOT NULL,
    morning_start_time time without time zone NOT NULL,
    morning_end_time time without time zone NOT NULL,
    afternoon_start_time time without time zone NOT NULL,
    afternoon_end_time time without time zone NOT NULL,
...
--
-- Name: route_schedule_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.route_schedule ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.route_schedule_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: commutes id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: commutes commutes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: route_schedule route_schedule_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.route_schedule
    ADD CONSTRAINT route_schedule_id_key UNIQUE (id);
...
--
-- Name: commutes update_commute_timezone; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_commute_timezone BEFORE INSERT OR UPDATE ON public.commutes FOR EACH ROW EXECUTE FUNCTION public.update_adjusted_query_time();


--
-- Name: routes update_route_timezone; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_route_timezone AFTER UPDATE ON public.routes FOR EACH ROW EXECUTE FUNCTION public.update_related_commutes();
...
--
-- Name: commutes fk_route; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: routes fk_user; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: commutes fk_user; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: route_schedule route_schedule_route_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.route_schedule
    ADD CONSTRAINT route_schedule_route_id_fkey FOREIGN KEY (route_id) REFERENCES public.routes(id);
...
--
-- Name: commutes; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION convert_to_timezone(query_time timestamp with time zone, target_timezone text); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.convert_to_timezone(query_time timestamp with time zone, target_timezone text) TO anon;
GRANT ALL ON FUNCTION public.convert_to_timezone(query_time timestamp with time zone, target_timezone text) TO authenticated;
GRANT ALL ON FUNCTION public.convert_to_timezone(query_time timestamp with time zone, target_timezone text) TO service_role;


--
-- Name: FUNCTION update_adjusted_query_time(); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.update_adjusted_query_time() TO anon;
GRANT ALL ON FUNCTION public.update_adjusted_query_time() TO authenticated;
GRANT ALL ON FUNCTION public.update_adjusted_query_time() TO service_role;


--
-- Name: FUNCTION update_related_commutes(); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.update_related_commutes() TO anon;
GRANT ALL ON FUNCTION public.update_related_commutes() TO authenticated;
GRANT ALL ON FUNCTION public.update_related_commutes() TO service_role;
...
--
-- Name: TABLE commutes; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: SEQUENCE commutes_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE route_schedule; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.route_schedule TO anon;
GRANT ALL ON TABLE public.route_schedule TO authenticated;
GRANT ALL ON TABLE public.route_schedule TO service_role;


--
-- Name: SEQUENCE route_schedule_id_seq; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON SEQUENCE public.route_schedule_id_seq TO anon;
GRANT ALL ON SEQUENCE public.route_schedule_id_seq TO authenticated;
GRANT ALL ON SEQUENCE public.route_schedule_id_seq TO service_role;
...
--
-- Name: SEQUENCE routes_id_seq; Type: ACL; Schema: public; Owner: -
--
